...
\subsection{Constrained by the bit diameter}

In this section, we consider the case where we want to ensure that the
narrowest slot is the bit diameter, $B$.
...
than the bit diameter, because we allow the bit to extend over the ends of the
